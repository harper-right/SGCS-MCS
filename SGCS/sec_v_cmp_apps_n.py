...
# cmp_apps is a comparison with strategies in other references; n indicates that the horizontal axis is task_num
if __name__ == '__main__':
    ...
    # index_i
    par_name = 'cmp_N'  # Compared + Task number
    ...
    for set_idx, set_name in enumerate(data_sets_lst):
        ...
        for rep in range(game_rep_time):
            g_info.omg, g_info.c = g_info.refresh_workers()  # 重新生成工人群体
            # get best p1
